...
@section('content')
    ...
    <div class="w-full max-w-xs mx-auto font-sans text-sm leading-none">
        ...
        <div class="rounded-b-2xl bg-white ring-1 ring-black/5 divide-y divide-gray-100">
            @foreach($items as $item)
                <a href="{{$item['href']}}" type="button"
                        class="flex link items-center w-full justify-between px-4 py-3 bg-white hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition">

                <span class="flex items-center gap-2">
                    {{-- иконку меняйте на подходящую --}}
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500"
                         fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M12 11c0-.5304.2107-1.0391.5858-1.4142C12.9609 9.2107 13.4696 9 14 9c.5304 0 1.0391.2107 1.4142.5858C15.7893 9.9609 16 10.4696 16 11s-.2107 1.0391-.5858 1.4142C15.0391 12.7893 14.5304 13 14 13c-.5304 0-1.0391-.2107-1.4142-.5858C12.2107 12.0391 12 11.5304 12 11z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- CDN Tailwind (удали, если уже подключён в проекте) -->
