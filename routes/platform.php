...
use App\Orchid\Screens\BotRolesScreen;
use App\Orchid\Screens\BotUsersScreen;
use App\Orchid\Screens\CheckTasksScreen;
...
Route::screen('/history', \App\Orchid\Screens\HistoryScreen::class)->name('history_admin');
...
Route::screen('/botuser/{user?}', UserProfile::class)
    ->name('user.profile');
Route::screen('/task/{task?}', CheckTasksScreen::class)
    ->name('user.profile');
